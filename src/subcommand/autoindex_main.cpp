...
void help_autoindex(char** argv) {
    ...
    << "    -x, --tx-gff FILE      GTF/GFF file with reference transcript annotations (may repeat)" << endl
    << "    -H, --hap-tx-gff FILE  GTF/GFF file with transcript annotations for haplotype sequences (may repeat)" << endl
    << "  configuration:" << endl
